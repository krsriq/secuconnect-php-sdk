 ...
 */
class SmartTransactionsBasketProductGroup implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SmartTransactionsBasketProductGroup';
