 ...
 */
class SmartDevicesDevice implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SmartDevicesDevice';
    ...
    /**
     * Sets object
     * @param string|null $object Object of device
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string|null $id Id of device
     * @return $this
     */
