 ...
 */
class SmartDeviceUserPin implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SmartDeviceUserPin';
    ...
    /**
     * Sets user_pin
     * @param string|null $user_pin user code from authentication response
     * @return $this
     */
