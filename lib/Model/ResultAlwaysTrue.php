 ...
 */
class ResultAlwaysTrue implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ResultAlwaysTrue';
    ...
    /**
     * Sets result
     * @param bool|null $result Result (will always be equal to true)
     * @return $this
     */
