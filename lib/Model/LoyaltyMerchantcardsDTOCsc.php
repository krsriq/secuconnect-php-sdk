 ...
 */
class LoyaltyMerchantcardsDTOCsc implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'LoyaltyMerchantcardsDTOCsc';
    ...
    /**
     * Sets csc
     * @param int|null $csc Card security code
     * @return $this
     */
    public function setCsc(?int $csc): static
    {
