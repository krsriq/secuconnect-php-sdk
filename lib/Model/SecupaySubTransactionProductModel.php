 ...
 */
class SecupaySubTransactionProductModel implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SecupaySubTransactionProductModel';
