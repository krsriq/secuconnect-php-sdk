 ...
 */
class InvitedBy implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'InvitedBy';
     ...
     * @return $this
     */
    public function setInvited(?string $invited): static
    {
