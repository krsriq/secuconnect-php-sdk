 ...
 */
class SecupayTransactionDTOExternalInvoicePdf implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SecupayTransactionDTOExternalInvoicePdf';
     ...
     * @param bool|null $update_existing Update existing invoice PDF
     * @return $this
     */
    public function setUpdateExisting(?bool $update_existing): static
    {
