 ...
 */
class PrepaidSalesProductDTO implements ArrayAccess, ModelInterface
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'PrepaidSalesProductDTO';
    ...
    /**
     * Sets item
     * @param string|null $item prepaid sales transaction id
     * @return $this
     */
