 ...
 */
class ServicesIdentrequestsApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function addIdentrequests(\Secuconnect\Client\Model\ServicesIdentrequestsProductDTO $body): \Secuconnect\Client\Model\ServicesIdentrequestsProductModel
    {
        return $this->addIdentrequestsWithHttpInfo($body)[0];
    }
     ...
     * @throws Exception
     */
    public function addIdentrequestsWithHttpInfo(\Secuconnect\Client\Model\ServicesIdentrequestsProductDTO $body): array
    {
        // parse inputs
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel'
                );
     ...
     * @throws Exception
     */
    public function getAll(?int $count = null, ?int $offset = null, ?string $fields = null, ?string $q = null, ?string $sort = null): \Secuconnect\Client\Model\ServicesIdentrequestsList
    {
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\ServicesIdentrequestsList'
                );
     ...
     * @throws Exception
     */
    public function getOne(string $identrequest_id): \Secuconnect\Client\Model\ServicesIdentrequestsProductModel
    {
