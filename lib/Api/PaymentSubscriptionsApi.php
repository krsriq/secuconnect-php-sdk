 ...
 */
class PaymentSubscriptionsApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function paymentSubscriptionGetById(string $payment_subscription_id): \Secuconnect\Client\Model\PaymentSubscriptionsProductModel
    {
        return $this->paymentSubscriptionGetByIdWithHttpInfo($payment_subscription_id)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSubscriptionGetByIdWithHttpInfo(string $payment_subscription_id): array
    {
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\PaymentSubscriptionsProductModel'
                );
     ...
     * @throws Exception
     */
    public function paymentSubscriptionsGet(?int $count = null, ?int $offset = null, ?string $fields = null, ?string $q = null, ?string $sort = null): \Secuconnect\Client\Model\PaymentSubscriptionsList
    {
        return $this->paymentSubscriptionsGetWithHttpInfo($count, $offset, $fields, $q, $sort)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSubscriptionsGetWithHttpInfo(?int $count = null, ?int $offset = null, ?string $fields = null, ?string $q = null, ?string $sort = null): array
    {
        // parse inputs
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\PaymentSubscriptionsList'
                );
