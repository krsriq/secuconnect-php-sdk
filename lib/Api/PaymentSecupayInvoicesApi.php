 ...
 */
class PaymentSecupayInvoicesApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function paymentSecupayInvoicesGetById(string $payment_invoice_id): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupayInvoicesGetByIdWithHttpInfo($payment_invoice_id)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupayInvoicesGetByIdWithHttpInfo(string $payment_invoice_id): array
    {
     ...
     * @throws Exception
     */
    public function paymentSecupayinvoicesPost(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupayinvoicesPostWithHttpInfo($body)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupayinvoicesPostWithHttpInfo(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): array
    {
        // parse inputs
