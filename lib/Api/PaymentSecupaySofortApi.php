 ...
 */
class PaymentSecupaySofortApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function paymentSecupaySofortGetById(string $payment_prepay_id): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupaySofortGetByIdWithHttpInfo($payment_prepay_id)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupaySofortGetByIdWithHttpInfo(string $payment_prepay_id): array
    {
     ...
     * @throws Exception
     */
    public function paymentSecupaysofortPost(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupaysofortPostWithHttpInfo($body)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupaysofortPostWithHttpInfo(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): array
    {
        // parse inputs
