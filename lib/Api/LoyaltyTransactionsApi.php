 ...
 */
class LoyaltyTransactionsApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function getAll(?int $count = null, ?int $offset = null, ?string $fields = null, ?string $q = null, ?string $sort = null): \Secuconnect\Client\Model\LoyaltyTransactionsList
    {
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\LoyaltyTransactionsList'
                );
     ...
     * @throws Exception
     */
    public function getOne(string $loyalty_transaction_id): \Secuconnect\Client\Model\LoyaltyTransactionsProductModel
    {
        return $this->getOneWithHttpInfo($loyalty_transaction_id)[0];
    }
     ...
     * @throws Exception
     */
    public function getOneWithHttpInfo(string $loyalty_transaction_id): array
    {
        // verify the required parameter 'loyalty_transaction_id' is set
        if (empty($loyalty_transaction_id)) {
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    $responseType = '\Secuconnect\Client\Model\LoyaltyTransactionsProductModel'
                );
