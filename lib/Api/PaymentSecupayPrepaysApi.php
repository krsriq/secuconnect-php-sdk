 ...
 */
class PaymentSecupayPrepaysApi extends ApiController
{
     ...
     * @throws Exception
     */
    public function paymentSecupayPrepaysGetById(string $payment_prepay_id): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupayPrepaysGetByIdWithHttpInfo($payment_prepay_id)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupayPrepaysGetByIdWithHttpInfo(string $payment_prepay_id): array
    {
        // verify the required parameter 'payment_prepay_id' is set
        if (empty($payment_prepay_id)) {
            throw new InvalidArgumentException(
     ...
     * @throws Exception
     */
    public function paymentSecupayprepaysPost(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): \Secuconnect\Client\Model\SecupayTransactionProductModel
    {
        return $this->paymentSecupayprepaysPostWithHttpInfo($body)[0];
    }
     ...
     * @throws Exception
     */
    public function paymentSecupayprepaysPostWithHttpInfo(\Secuconnect\Client\Model\SecupayTransactionProductDTO $body): array
    {
        // parse inputs
